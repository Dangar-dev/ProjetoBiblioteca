...
namespace ProjetoBiblioteca.Controllers
{
    public class EmprestimoController : Controller
    {
        ...
        //=========== Helper simples do carrinho (string CSV <-> List<int>)
        ...
        // Adiciona 1 por livro (IDs Únicos)
        ...
        public IActionResult Carrinho()
        {
            ...
            if (ids.Count > 0)
            {
                ...
                using (var cmd2 = new MySqlCommand("sp_leitor_listar", conn)
